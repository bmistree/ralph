...
public final class PartnerBackoutCommitRequestProto {
  ...
  public static final class PartnerBackoutCommitRequest extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return waldo_protobuffs.PartnerBackoutCommitRequestProto.internal_static_PartnerBackoutCommitRequest_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return waldo_protobuffs.PartnerBackoutCommitRequestProto.internal_static_PartnerBackoutCommitRequest_fieldAccessorTable;
    }
    ...
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseFrom(
    ...
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseFrom(
    ...
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest prototype) {
    ...
    public static final class Builder extends
       ...
       implements waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return waldo_protobuffs.PartnerBackoutCommitRequestProto.internal_static_PartnerBackoutCommitRequest_descriptor;
      }
      ...
      // Construct using waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.getDescriptor();
      }
      
      public waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest getDefaultInstanceForType() {
        return waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.getDefaultInstance();
      }
      
      public waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest build() {
        waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest result = buildPartial();
      ...
      private waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest buildPartial() {
        waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest result = new waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest) {
          return mergeFrom((waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest)other);
        } else {
      ...
      public Builder mergeFrom(waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest other) {
        if (other == waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.getDefaultInstance()) return this;
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_PartnerBackoutCommitRequest_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.class,
              waldo_protobuffs.PartnerBackoutCommitRequestProto.PartnerBackoutCommitRequest.Builder.class);
          return null;
        }
      };
