 ...
 * dewaldoify into.
 */
public class SpeculativeAtomicInternalList<V,D> 
               ...
               RalphInternalListInterface<V,D>
{
    ...
    {
        SpeculativeAtomicInternalList<V,D> to_return;
        to_return = new SpeculativeAtomicInternalList<V,D>(ralph_globals);
    ...
    public SpeculativeAtomicInternalList(RalphGlobals ralph_globals)
    {
        super(ralph_globals);
    ...
    {
        Util.logger_assert(
            "Must fill in write_if_different in " +
            "SpeculativeAtomicInternalList.");
    }
    @Override
