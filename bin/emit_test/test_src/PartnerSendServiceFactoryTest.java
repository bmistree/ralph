...
import emit_test_package.SingleSideServiceFactory.ServiceReceiver;
import emit_test_package.PartnerServiceFactory.ServiceFactorySender;
...
public class PartnerSendServiceFactoryTest
{
    ...
    public static boolean run_test()
    {
        try {
            ...
            RalphGlobals receiver_globals = new RalphGlobals();
